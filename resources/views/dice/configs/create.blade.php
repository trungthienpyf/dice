        ...
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                    <h5 class="mb-0">Tạo cấu hình mới</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('dice.configs.store') }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label for="name" class="form-label">Tên cấu hình</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="Cấu hình test" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('td') is-invalid @enderror"
                                   id="td" name="td" value="500" required>
                            @error('td')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('cc') is-invalid @enderror"
                                   id="cc" name="cc" value="18" required>
                            @error('cc')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('ts') is-invalid @enderror"
                                   id="ts" name="ts" value="250" required>
                            @error('ts')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="same_row" class="form-label">Bộ</label>
                            <input type="number" class="form-control @error('same_row') is-invalid @enderror"
                                   id="same_row" name="same_row" value="3" required>
                            @error('same_row')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
